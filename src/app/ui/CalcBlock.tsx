...
export default function CalcBlock() {
  ...
  return (
    <div className="max-w-[96vw] w-[1400px] min-h-[600px] mx-auto my-12 bg-white rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden" style={{ minWidth: 900 }}>
      ...
      <div className="flex-1 p-16 flex flex-col items-center justify-center">
        <h2 className="text-3xl font-bold mb-10 text-blue-700 text-center">Калькулятор заявки</h2>
        <div className="max-w-2xl w-full mx-auto">
          <div className="mb-8 min-h-[196px] flex flex-col justify-center relative">
            <div className="text-xl font-semibold mb-4 text-blue-800 min-h-[32px]">{steps[step].label}</div>
          ...
          <div className="flex justify-between mt-12">
            <button
              type="button"
              className="px-8 py-4 rounded-xl border-2 text-xl font-medium transition bg-white border-blue-200 text-blue-700 hover:bg-blue-50 disabled:opacity-50"
            ...
            {step === steps.length - 1 ? (
              <button
                type="button"
                className="px-8 py-4 rounded-xl border-2 text-xl font-medium transition bg-blue-600 text-white border-blue-600 hover:bg-blue-700 disabled:opacity-50"
