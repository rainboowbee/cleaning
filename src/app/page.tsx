...
export default function Home() {
  return (
    <main className="flex flex-col gap-16 items-center w-full bg-gradient-to-br from-blue-50 via-white to-blue-100 min-h-screen">
      {/* Приветственный блок с CTA */}
      <section
        className="w-full bg-gradient-to-r from-blue-600 to-blue-400 py-16 flex flex-col items-center text-center px-4 shadow-lg rounded-b-3xl"
      >
      ...
      {/* Преимущества */}
      <section
        className="w-full bg-white/80 py-14 px-4 shadow-inner"
      >
        <h2 className="text-2xl font-bold mb-10 text-center text-blue-700">Наши преимущества</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div
            className="flex flex-col items-center text-center bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 border border-blue-100"
          >
      ...
      {/* Форма заявки */}
      <section
        className="w-full bg-gradient-to-r from-blue-100 to-blue-300 py-14 px-4 shadow-inner"
        id="leadform"
      >
